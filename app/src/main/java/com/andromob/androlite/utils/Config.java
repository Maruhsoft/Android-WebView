...
public class Config {
    ...
    public static boolean isAdsEnabled = true; // REPLACE true TO false IF YOU WANT TO TURN OFF ADS

    public static String ONESIGNAL_APP_ID = "a92c15c0-1702-4c4a-b6be-e78b5f9c703c";
}
